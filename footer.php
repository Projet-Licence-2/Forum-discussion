...
<div class="container-fluid">
    <div class="row footer-top">
        <div class="col-sm-4 text-center">
            ...
            <h6 class="ft-desp"><b>forum Name</b> : Discuission 
                <br>Country Name : guinnée-conakry
            </h6>
            <h4 class="details">
                <a class="contact" href="tel:+977-1-4107223">
                    <i class="fa fa-phone" aria-hidden="true"></i> +224-620304050</a>
                </h4>
            </div>
            <div class="col-sm-4 text-center border-left">
                ...
                <div class="address-member">
                    <p class="member">
                        <b>Groupe</b> : les étudiants du centre informatique GA3
                    </p>
               </div>
           </div>
	...
	<div class="row ft-copyright pt-2 pb-2" style="padding-left: 25px;">
		<div class="col-sm-4 text-pp-crt">cpoyright 2022 All  Rights Reserved</div>
